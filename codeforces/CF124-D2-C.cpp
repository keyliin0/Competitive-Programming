/* 
	...
	a greedy way to check for a solution is to take car with max frequency and check if we can make 
	all positions of multiples of two equal the same caracter of s[2] and then we check the other postion where x > 2 and x * 2 <= length of the string
