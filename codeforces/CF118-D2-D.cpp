...
int solve(int i1,int i2,int last,int cnt) {
	if (cnt > k1 && last == 1) return 0; // if there is have more than k1 consecutive footmen then this is an invalid case
	if (cnt > k2 && last == 2) return 0;// if there is have more than k2 consecutive horsemen then this is an invalid case
