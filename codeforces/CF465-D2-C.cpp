/*
	if we can make a substring of length 3 not palindrome then we are sure that if we take any substring
	that contain the non palindrome substring is not palindrome
*/
#include <bits/stdc++.h>
using namespace std;
